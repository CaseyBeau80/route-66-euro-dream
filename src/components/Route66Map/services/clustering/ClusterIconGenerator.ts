    ...
    const svgContent = `
      <svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 ${size} ${size}">
        ...
        <rect x="${size * 0.15}" y="${size * 0.55}" width="${size * 0.7}" height="${size * 0.18}"
              fill="#2d8f47" stroke="#1e5f31" stroke-width="1.5" rx="${size * 0.03}" filter="url(#shadow)"/>
        
        <!-- Car roof -->
        <rect x="${size * 0.25}" y="${size * 0.42}" width="${size * 0.5}" height="${size * 0.13}"
              fill="#2d8f47" stroke="#1e5f31" stroke-width="1.5" rx="${size * 0.025}"/>
        ...
        <rect x="${size * 0.12}" y="${size * 0.6}" width="${size * 0.76}" height="${size * 0.08}"
              fill="#333333" stroke="#1e5f31" stroke-width="1" rx="${size * 0.01}"/>
        ...
        <rect x="${size * 0.23}" y="${size * 0.52}" width="${size * 0.02}" height="${size * 0.04}"
              fill="#2d8f47" stroke="#1e5f31" stroke-width="0.5"/>
        ...
        <circle cx="${size * 0.5}" cy="${size * 0.22}" r="${size * 0.16}"
                fill="#ffffff" stroke="#2d8f47" stroke-width="2.5" filter="url(#shadow)"/>
        ...
        <text x="${size * 0.5}" y="${size * 0.29}" text-anchor="middle"
              fill="#2d8f47" font-family="Arial, sans-serif" 
