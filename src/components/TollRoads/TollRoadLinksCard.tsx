    ...
    <Card className="border-2 border-blue-500 bg-white shadow-lg hover:shadow-xl transition-all duration-300">
      <CardContent className="p-6">
        <div className="text-center mb-4">
          ...
          <p className="text-gray-700 max-w-3xl mx-auto text-base leading-relaxed">{tollRoadLinks.subtitle}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {tollRoadLinks.links.map((link, index) => (
            <a
              ...
              className="group block bg-gray-50 p-4 rounded-lg border-2 border-gray-300 hover:border-blue-500 hover:bg-white transition-all duration-300"
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-base font-route66 text-blue-500 group-hover:text-blue-600 mb-1 transition-colors duration-300 uppercase font-bold">
                    {link.name}
                  </h4>
        ...
        <div className="mt-4 p-3 bg-blue-50 rounded-lg border-2 border-blue-200 shadow-sm">
