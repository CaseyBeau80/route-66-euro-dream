    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-pink-100 to-purple-100 text-pink-600 px-4 py-2 rounded-full text-sm font-semibold mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {content.stats.map((stat, index) => (
            <div key={index} className="text-center p-6 bg-route66-background-section rounded-xl border border-route66-border">
        ...
        {/* Instagram Carousel */}
        <div className="bg-gradient-to-br from-route66-background-section to-white p-8 rounded-2xl border border-route66-border shadow-lg">
