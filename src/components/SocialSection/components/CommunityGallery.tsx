...
const CommunityGallery: React.FC<CommunityGalleryProps> = ({ language }) => {
    ...
    <Card className="border-route66-border">
      <CardContent className="p-8">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-12 h-12 bg-route66-accent/10 rounded-full mb-4">
            <Users className="h-6 w-6 text-route66-accent" />
          </div>
          <h3 className="text-2xl font-bold text-route66-text-primary mb-2">
