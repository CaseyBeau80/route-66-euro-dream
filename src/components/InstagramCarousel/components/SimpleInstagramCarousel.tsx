...
const SimpleInstagramCarousel = () => {
  ...
  return <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-12 bg-white p-2 rounded-xl shadow-2xl border-4 border-route66-primary">
          <h2 className="text-4xl font-route66 text-route66-primary mb-4 font-bold">
            ROUTE 66 ADVENTURES
          </h2>
        ...
        <div className="space-y-8">
          ...
          {posts.length > postsPerView && <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex items-center gap-4">
                <button onClick={goToPrevious} disabled={currentIndex === 0} className="flex items-center gap-2 px-6 py-3 bg-blue-100 border-2 border-blue-300 text-route66-primary rounded-lg font-bold disabled:opacity-50 disabled:cursor-not-allowed hover:bg-blue-200 hover:border-blue-400 transition-colors duration-200">
                  <ChevronLeft className="w-5 h-5" />
                  Previous
                </button>
                
                <button onClick={goToNext} disabled={currentIndex + postsPerView >= posts.length} className="flex items-center gap-2 px-6 py-3 bg-route66-primary border-2 border-route66-primary text-white rounded-lg font-bold disabled:opacity-50 disabled:cursor-not-allowed hover:bg-route66-primary-dark hover:border-route66-primary-dark transition-colors duration-200">
                  Next
