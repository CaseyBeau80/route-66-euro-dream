...
const ShareTripDaySegmentCard: React.FC<ShareTripDaySegmentCardProps> = ({
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-4 mb-4 break-inside-avoid">
      ...
      {/* Drive Time Category - Updated to use correct categories */}
        ...
        <div className="mt-3 pt-2 border-t border-gray-100">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className={`px-2 py-1 rounded text-xs font-medium ${
              segment.driveTimeCategory.category === 'light' ? 'bg-green-100 text-green-700' :
              segment.driveTimeCategory.category === 'moderate' ? 'bg-blue-100 text-blue-700' :
              segment.driveTimeCategory.category === 'heavy' ? 'bg-orange-100 text-orange-700' :
