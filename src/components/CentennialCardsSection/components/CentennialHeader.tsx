  ...
  return (
    <div className="text-center mb-12">
      ...
      <div className="relative inline-block mb-6">
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 top-full">
          <div className="flex items-center justify-center mt-2 mb-2">
            <div className="w-1 h-1 bg-blue-400 rounded-full motion-safe:animate-birthday-sparkle motion-reduce:animate-none mr-1"></div>
            <div className="w-1 h-1 bg-blue-500 rounded-full motion-safe:animate-birthday-sparkle motion-reduce:animate-none mx-1" style={{ animationDelay: '0.3s' }}></div>
            <div className="w-1 h-1 bg-blue-400 rounded-full motion-safe:animate-birthday-sparkle motion-reduce:animate-none ml-1" style={{ animationDelay: '0.6s' }}></div>
          </div>
        </div>
      </div>
      ...
      <h2 
        ...
        style={{
          filter: 'drop-shadow(0 4px 8px rgba(59, 130, 246, 0.15)) drop-shadow(0 0 20px rgba(99, 102, 241, 0.1))',
      ...
      <div className="mb-4 animate-fade-in" style={{ animationDelay: '0.15s' }}>
        <p className="text-sm italic text-slate-500 tracking-wider font-medium">
      ...
      <div className="flex justify-center items-center gap-4 mt-6 animate-fade-in" style={{ animationDelay: '0.4s' }}>
        ...
        <Sparkles className="h-6 w-6 text-blue-500 motion-safe:animate-birthday-sparkle motion-reduce:animate-none" />
