...
const Hero = ({ language, onExploreMap, isMapOpen = false }: HeroProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Content overlay - positioned higher for better contrast against dark asphalt */}
      <div className="relative z-20 flex flex-col items-center justify-start pt-20 h-full text-center px-4 max-w-6xl mx-auto">
